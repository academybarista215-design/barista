      ...
      <div className="max-w-7xl mx-auto">
        <div className="relative overflow-hidden rounded-3xl bg-gradient-to-br from-primary via-primary-container to-tertiary p-12 md:p-24 text-center text-white">
          ...
          <div className="relative z-10">
            <h2 className="text-[clamp(2rem,6vw,3.5rem)] font-serif font-bold mb-8 leading-[1.2]">
              আজই শুরু করুন আপনার <br /> Barista ক্যারিয়ার
            </h2>
            <p className="text-[clamp(1.1rem,3vw,1.6rem)] opacity-90 mb-12 max-w-2xl mx-auto leading-[1.6]">
              সঠিক প্রশিক্ষণ আর অভিজ্ঞ মেন্টরশিপ নিয়ে নিজেকে একজন দক্ষ বারিস্টা হিসেবে প্রতিষ্ঠিত করুন। আসন সংখ্যা সীমিত।
            </p>
            <motion.button 
              whileHover={{ scale: 1.05 }}
              whileTap={{ scale: 0.95 }}
              className="bg-white text-primary px-12 py-5 rounded-full text-[clamp(1rem,2vw,1.2rem)] font-bold shadow-2xl"
            >
              Enroll Now
            </motion.button>
          </div>
